...
import FieldParameters from "../../components/sunflower/FieldParameters";
import sunflowerStore from "../../stores/sunflowerStore";
import CustomizedSnackbars from "../../components/common/CustomizedSnackbars";
import SeasonsParametrs from "../../components/sunflower/SeasonsParametrs";
import { Breadcrumbs, Link } from "@mui/material";
import Result from "../../components/sunflower/Result";
...
const Sunflower = () => {
  ...
  const handleNext = () => {
    ...
    if (sunflowerStore.getEmptyFields(activeStep).length == 0) {
  ...
  const handleRestart = () => {
    sunflowerStore.resetCalculation();
    setActiveStep(0);
  };
  return (
    <Container maxWidth="md" sx={{ mt: 10, mb: 4 }} ref={componentRef}>
      <Breadcrumbs aria-label="breadcrumb" sx={{ mb: 2 }}>
        ...
        <Typography color="text.primary">Подсолнечник</Typography>
      </Breadcrumbs>
